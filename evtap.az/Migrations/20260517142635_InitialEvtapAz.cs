...
{
    /// <inheritdoc />
    public partial class InitialEvtapAz : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameRu = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NameEn = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HasDistricts = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BuildingProjects", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BuildingProjects_BuildingTypes_BuildingTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ListingNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CityId = table.Column<int>(type: "int", nullable: false),
                    DistrictId = table.Column<int>(type: "int", nullable: true),
                    SettlementId = table.Column<int>(type: "int", nullable: true),
                    MetroStationId = table.Column<int>(type: "int", nullable: true),
                    ...
                    AreaMin = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    AreaMax = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    RoomMin = table.Column<int>(type: "int", nullable: true),
                    ...
                    RepairTypeId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Listings_BuildingProjects_BuildingProjectId",
                        column: x => x.BuildingProjectId,
                        principalTable: "BuildingProjects",
                        principalColumn: "Id");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Listings_MetroStations_MetroStationId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Listings_RepairTypes_RepairTypeId",
                        column: x => x.RepairTypeId,
                        principalTable: "RepairTypes",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Listings_Settlements_SettlementId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BuildingProjects_BuildingTypeId",
                table: "BuildingProjects",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Listings_BuildingProjectId",
                table: "Listings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Listings_MetroStationId",
                table: "Listings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Listings_RepairTypeId",
                table: "Listings",
                column: "RepairTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Listings_SettlementId",
                table: "Listings",
                column: "SettlementId");
